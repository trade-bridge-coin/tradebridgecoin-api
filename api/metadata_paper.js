module.exports = Object.freeze({
    metadata: {
        ...
        tokenAddress: '0x10d8587861c430091a3961b912e39c2e7c9907cc',
        ...
        data: {
            ...
            categories: {
                ...
                '5': {
                    description: `Commodity futures on China's Dalian, Zhenzhou and Shanghai Commodities Exchanges`,
                    postfix: ['CNC'],
                    examples:['RB.CNC', 'M.CNC', 'TA.CNC'],
                    timeZone: "Asia/Shanghai",
                    tradingHours: {
                        time: ["00:00-02:30", "09:00-10:15", "10:30-11:30", "13:30-15:00", "21:00-24:00"],
                        day: ['mon', 'tue', 'wed', 'thu', 'fri', 'sat'],
                        dayOff:[]
                    },
                    providers:['sina'],
                    leverage:[0, 20],
                    symbols: [/^[A-Z]{2}[0-9]{2}(0[1-9]|1[012]).CNC$/g]
                }
            }
        }
    }
